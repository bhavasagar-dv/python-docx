...
from python_docx.document import Document
from python_docx.enum.style import WD_STYLE_TYPE
from python_docx.enum.table import (
    WD_ALIGN_VERTICAL,
    WD_ROW_HEIGHT,
    WD_TABLE_ALIGNMENT,
    WD_TABLE_DIRECTION,
...
from python_docx.oxml.table import CT_Row, CT_Tbl, CT_TblGridCol, CT_Tc
from python_docx.parts.document import DocumentPart
from python_docx.shared import Emu, Inches, Length
from python_docx.table import Table, _Cell, _Column, _Columns, _Row, _Rows
