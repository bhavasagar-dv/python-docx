...
from python_docx.enum.section import WD_HEADER_FOOTER, WD_ORIENTATION, WD_SECTION_START
from python_docx.oxml.ns import nsmap
from python_docx.oxml.shared import CT_OnOff
from python_docx.oxml.simpletypes import ST_SignedTwipsMeasure, ST_TwipsMeasure, XsdString
...
from python_docx.shared import Length, lazyproperty
