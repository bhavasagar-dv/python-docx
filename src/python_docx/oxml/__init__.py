...
from python_docx.oxml.parser import OxmlElement, parse_xml, register_element_cls
from python_docx.oxml.shape import (
    CT_Anchor,
    CT_Blip,
...
from python_docx.oxml.shared import CT_DecimalNumber, CT_OnOff, CT_String
...
from python_docx.oxml.text.run import (
    CT_R,
    CT_Br,
    CT_Cr,
    CT_NoBreakHyphen,
