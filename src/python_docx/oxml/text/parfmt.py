...
from python_docx.enum.text import (
    WD_ALIGN_PARAGRAPH,
    WD_LINE_SPACING,
    WD_TAB_ALIGNMENT,
    WD_TAB_LEADER,
)
from python_docx.oxml.simpletypes import ST_SignedTwipsMeasure, ST_TwipsMeasure
...
if TYPE_CHECKING:
    ...
    from python_docx.oxml.shared import CT_String
