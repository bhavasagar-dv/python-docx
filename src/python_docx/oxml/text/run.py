...
from python_docx.oxml.simpletypes import ST_BrClear, ST_BrType
from python_docx.oxml.text.font import CT_RPr
from python_docx.oxml.xmlchemy import BaseOxmlElement, OptionalAttribute, ZeroOrMore, ZeroOrOne
from python_docx.shared import TextAccumulator

if TYPE_CHECKING:
    from python_docx.oxml.shape import CT_Anchor, CT_Inline
    from python_docx.oxml.text.pagebreak import CT_LastRenderedPageBreak
    from python_docx.oxml.text.parfmt import CT_TabStop
