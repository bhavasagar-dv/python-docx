...
from python_docx.enum.table import WD_CELL_VERTICAL_ALIGNMENT, WD_ROW_HEIGHT_RULE, WD_TABLE_DIRECTION
from python_docx.exceptions import InvalidSpanError
from python_docx.oxml.ns import nsdecls, qn
from python_docx.oxml.parser import parse_xml
from python_docx.oxml.shared import CT_DecimalNumber
from python_docx.oxml.simpletypes import (
    ST_Merge,
    ST_TblLayoutType,
    ST_TblWidth,
    ST_TwipsMeasure,
...
from python_docx.shared import Emu, Length, Twips

if TYPE_CHECKING:
    from python_docx.enum.table import WD_TABLE_ALIGNMENT
    from python_docx.enum.text import WD_ALIGN_PARAGRAPH
    from python_docx.oxml.shared import CT_OnOff, CT_String
    from python_docx.oxml.text.parfmt import CT_Jc
