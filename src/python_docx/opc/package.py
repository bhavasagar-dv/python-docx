...
from python_docx.opc.pkgwriter import PackageWriter
from python_docx.opc.rel import Relationships
from python_docx.shared import lazyproperty

if TYPE_CHECKING:
    from python_docx.opc.coreprops import CoreProperties
    from python_docx.opc.part import Part
    from python_docx.opc.rel import _Relationship  # pyright: ignore[reportPrivateUsage]
