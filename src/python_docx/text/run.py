...
from python_docx.drawing import Drawing
...
from python_docx.shared import StoryChild
...
if TYPE_CHECKING:
    ...
    from python_docx.enum.text import WD_UNDERLINE
    from python_docx.oxml.text.run import CT_R, CT_Text
