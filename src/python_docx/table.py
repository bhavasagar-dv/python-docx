...
from python_docx.enum.table import WD_CELL_VERTICAL_ALIGNMENT
from python_docx.oxml.simpletypes import ST_Merge
from python_docx.oxml.table import CT_TblGridCol
