...
from python_docx.enum.base import BaseEnum, BaseXmlEnum
...
class WD_CELL_VERTICAL_ALIGNMENT(BaseXmlEnum):
    ...
    Example::
        ...
        from python_docx.enum.table import WD_ALIGN_VERTICAL
...
class WD_ROW_HEIGHT_RULE(BaseXmlEnum):
    ...
    Example::
        ...
        from python_docx.enum.table import WD_ROW_HEIGHT_RULE
...
class WD_TABLE_DIRECTION(BaseEnum):
    ...
    Example::
        ...
        from python_docx.enum.table import WD_TABLE_DIRECTION
